...
<nav class="main-nav">
 	<ul class="main-nav-ul">
 		...
 		<li class="has-sub "><a href="#"><i class="fa fa-area-chart" style="font-size:18px">
		 </i> Manage Ground<span class="caret sub-arrow"></span></a>
 			<ul class="ul">
 				<li><a href="/addGround">Add Ground</a></li>
 				<li><a href="/viewGround">View Ground</a></li>
 			</ul>
 		</li>
    <li class="has-sub1"><a href="#"><i class="fa fa-rupee" style="font-size:18px">
		</i> Manage Rate_Time<span class="caret sub-arrow"></span></a>
      <ul class="ul1">
        <li><a href="/addRateTime">Add RateTime</a></li>
        <li ><a href="/viewRateTime">View RateTime</a></li>
      </ul>
		</li>
		<li  class=""><a href="{{url('/editprofile',Auth::user()->id)}}"><i class="fa fa-user" style="font-size:18px;color:white;">
		</i> Edit Profile</a></li>
